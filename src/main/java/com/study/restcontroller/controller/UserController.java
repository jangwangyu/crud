package com.study.restcontroller.controller;

import com.study.restcontroller.domain.UserDto;
import com.study.restcontroller.service.UserService;
...
public class UserController {
    ...
    public List<UserDto> findByGender(@PathVariable String gender) {return userService.findByGender(gender);}

    @PutMapping("/api/v1/users/{id}")
    public UserDto updateName(@PathVariable int id, @RequestParam String name) {
